...
export class LtEngine {
    static __wrap(ptr) {
        const obj = Object.create(LtEngine.prototype);
        obj.__wbg_ptr = ptr;
        LtEngineFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        LtEngineFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_ltengine_free(ptr, 0);
    }
    /**
     ...
     */
    active_rule_count() {
        const ret = wasm.ltengine_active_rule_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    check_json(text) {
        ...
        try {
            ...
            const ret = wasm.ltengine_check_json(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    check_matches_json(text) {
        ...
        try {
            const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.ltengine_check_matches_json(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    compile_failures_json() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.ltengine_compile_failures_json(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    lang() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.ltengine_lang(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    constructor(lang, pack, options) {
        ...
        const ret = wasm.ltengine_new(ptr0, len0, ptr1, len1, ptr2, len2);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
        LtEngineFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    static new_multi(lang, packs, options) {
        const ptr0 = passStringToWasm0(lang, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayJsValueToWasm0(packs, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        var ptr2 = isLikeNone(options) ? 0 : passStringToWasm0(options, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len2 = WASM_VECTOR_LEN;
        const ret = wasm.ltengine_new_multi(ptr0, len0, ptr1, len1, ptr2, len2);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return LtEngine.__wrap(ret[0]);
    }
    /**
     ...
     */
    variant() {
        const ret = wasm.ltengine_variant(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./lt_wasm_bg.js": import0,
    };
}

const LtEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_ltengine_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('lt_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
